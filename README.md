...
Persist Displays remembers monitor modes, scale, rotation, and layout when you use GNOME's `Super+P` display switcher.
...
- `extension.js` contains the extension logic.
